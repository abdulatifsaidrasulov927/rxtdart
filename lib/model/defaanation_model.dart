...
import 'package:rxtdart/model/license_model.dart';
import 'package:rxtdart/model/meaning_model.dart';
import 'package:rxtdart/model/phonetic_model.dart';

List<DefinationModel> emptyFromJson(String str) => List<DefinationModel>.from(
    json.decode(str).map((x) => DefinationModel.fromJson(x)));

String emptyToJson(List<DefinationModel> data) =>
...
class DefinationModel {
  ...
  factory DefinationModel.fromJson(Map<String, dynamic> json) =>
      DefinationModel(
        word: json["word"],
